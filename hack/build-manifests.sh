...
export OVS_MIRROR_PRODUCER_IMAGE_REPO=${OVS_MIRROR_PRODUCER_IMAGE_REPO:-quay.io/kubevirt}
export OVS_MIRROR_PRODUCER_IMAGE_NAME=${OVS_MIRROR_PRODUCER_IMAGE_NAME:-ovs-mirror-producer}
export OVS_MIRROR_PRODUCER_IMAGE_VERSION=${OVS_MIRROR_PRODUCER_IMAGE_VERSION:-latest}
export OVS_MIRROR_PRODUCER_IMAGE_PULL_POLICY=${OVS_MIRROR_PRODUCER_IMAGE_PULL_POLICY:-IfNotPresent}

export OVS_MIRROR_CONSUMER_IMAGE_REPO=${OVS_MIRROR_CONSUMER_IMAGE_REPO:-quay.io/kubevirt}
export OVS_MIRROR_CONSUMER_IMAGE_NAME=${OVS_MIRROR_CONSUMER_IMAGE_NAME:-ovs-mirror-consumer}
export OVS_MIRROR_CONSUMER_IMAGE_VERSION=${OVS_MIRROR_CONSUMER_IMAGE_VERSION:-latest}
export OVS_MIRROR_CONSUMER_IMAGE_PULL_POLICY=${OVS_MIRROR_CONSUMER_IMAGE_PULL_POLICY:-IfNotPresent}
