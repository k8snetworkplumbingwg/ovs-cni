...
export OVS_CNI_MIRROR_PRODUCER_IMAGE_NAME=${OVS_CNI_MIRROR_PRODUCER_IMAGE_NAME:-ovs-mirror-producer}
...
export OVS_CNI_MIRROR_CONSUMER_IMAGE_NAME=${OVS_CNI_MIRROR_CONSUMER_IMAGE_NAME:-ovs-mirror-consumer}
